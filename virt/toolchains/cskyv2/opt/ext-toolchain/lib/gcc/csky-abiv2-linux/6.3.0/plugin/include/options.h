...
#include "config/csky/abiv2_csky_opts.h"
...
#endif
#ifdef GENERATOR_FILE
extern int flag_cse_cc;
#else
  int x_flag_cse_cc;
#define flag_cse_cc global_options.x_flag_cse_cc
#endif
#ifdef GENERATOR_FILE
...
#endif
#ifdef GENERATOR_FILE
extern int flag_sched_prolog;
#else
  int x_flag_sched_prolog;
#define flag_sched_prolog global_options.x_flag_sched_prolog
#endif
#ifdef GENERATOR_FILE
...
#endif
#ifdef GENERATOR_FILE
extern int csky_arch_option;
#else
  int x_csky_arch_option;
#define csky_arch_option global_options.x_csky_arch_option
#endif
#ifdef GENERATOR_FILE
extern int flag_arch_ck803s;
#else
  int x_flag_arch_ck803s;
#define flag_arch_ck803s global_options.x_flag_arch_ck803s
#endif
#ifdef GENERATOR_FILE
...
#endif
#ifdef GENERATOR_FILE
extern int csky_branch_cost;
#else
  int x_csky_branch_cost;
#define csky_branch_cost global_options.x_csky_branch_cost
#endif
#ifdef GENERATOR_FILE
extern enum csky_processor_type csky_cpu_option;
#else
  enum csky_processor_type x_csky_cpu_option;
#define csky_cpu_option global_options.x_csky_cpu_option
#endif
#ifdef GENERATOR_FILE
extern int flag_csky_enhance_dsp;
#else
  int x_flag_csky_enhance_dsp;
#define flag_csky_enhance_dsp global_options.x_flag_csky_enhance_dsp
#endif
#ifdef GENERATOR_FILE
extern enum csky_fpu_type csky_fpu_index;
#else
  enum csky_fpu_type x_csky_fpu_index;
#define csky_fpu_index global_options.x_csky_fpu_index
#endif
#ifdef GENERATOR_FILE
extern int flag_csky_trust;
#else
  int x_flag_csky_trust;
#define flag_csky_trust global_options.x_flag_csky_trust
#endif
#ifdef GENERATOR_FILE
...
#define MASK_CACHE (1 << 0)
#define MASK_HARD_TP (1 << 1)
#define MASK_ANCHOR (1 << 2)
#define MASK_BACKTRACE (1 << 3)
#define MASK_BIG_ENDIAN (1 << 4)
#define MASK_LIBCCRT (1 << 5)
#define MASK_CONSTANT_POOL (1 << 6)
#define MASK_CP (1 << 7)
#define MASK_DIV (1 << 8)
#define MASK_DOUBLE_FLOAT (1 << 9)
#define MASK_DSP (1 << 10)
#define MASK_ELRW (1 << 11)
#define MASK_FDIVDU (1 << 12)
#define MASK_HARD_FLOAT (1 << 13)
#define MASK_HIGH_REGISTERS (1 << 14)
#define MASK_ATTRIBUTE_ISR (1 << 15)
#define MASK_SECURITY (1 << 16)
#define MASK_MP (1 << 17)
#define MASK_MULTIPLE_STLD (1 << 18)
#define MASK_PUSHPOP (1 << 19)
#define MASK_SMART (1 << 20)
#define MASK_STACK_SIZE (1 << 21)
#define MASK_STRICT_ALIGNMENT (1 << 22)
#define MASK_W_FIELD (1 << 23)

#define TARGET_CACHE ((target_flags & MASK_CACHE) != 0)
#define TARGET_CACHE_P(target_flags) ((target_flags & MASK_CACHE) != 0)
#define TARGET_HARD_TP ((target_flags & MASK_HARD_TP) != 0)
#define TARGET_HARD_TP_P(target_flags) ((target_flags & MASK_HARD_TP) != 0)
#define TARGET_ANCHOR ((target_flags & MASK_ANCHOR) != 0)
#define TARGET_ANCHOR_P(target_flags) ((target_flags & MASK_ANCHOR) != 0)
#define TARGET_BACKTRACE ((target_flags & MASK_BACKTRACE) != 0)
#define TARGET_BACKTRACE_P(target_flags) ((target_flags & MASK_BACKTRACE) != 0)
...
#define TARGET_CONSTANT_POOL ((target_flags & MASK_CONSTANT_POOL) != 0)
#define TARGET_CONSTANT_POOL_P(target_flags) ((target_flags & MASK_CONSTANT_POOL) != 0)
#define TARGET_CP ((target_flags & MASK_CP) != 0)
#define TARGET_CP_P(target_flags) ((target_flags & MASK_CP) != 0)
...
#define TARGET_DSP_P(target_flags) ((target_flags & MASK_DSP) != 0)
#define TARGET_ELRW ((target_flags & MASK_ELRW) != 0)
#define TARGET_ELRW_P(target_flags) ((target_flags & MASK_ELRW) != 0)
#define TARGET_FDIVDU ((target_flags & MASK_FDIVDU) != 0)
#define TARGET_FDIVDU_P(target_flags) ((target_flags & MASK_FDIVDU) != 0)
...
#define TARGET_HIGH_REGISTERS ((target_flags & MASK_HIGH_REGISTERS) != 0)
#define TARGET_HIGH_REGISTERS_P(target_flags) ((target_flags & MASK_HIGH_REGISTERS) != 0)
#define TARGET_ATTRIBUTE_ISR ((target_flags & MASK_ATTRIBUTE_ISR) != 0)
#define TARGET_ATTRIBUTE_ISR_P(target_flags) ((target_flags & MASK_ATTRIBUTE_ISR) != 0)
#define TARGET_SECURITY ((target_flags & MASK_SECURITY) != 0)
#define TARGET_SECURITY_P(target_flags) ((target_flags & MASK_SECURITY) != 0)
#define TARGET_MP ((target_flags & MASK_MP) != 0)
#define TARGET_MP_P(target_flags) ((target_flags & MASK_MP) != 0)
#define TARGET_MULTIPLE_STLD ((target_flags & MASK_MULTIPLE_STLD) != 0)
#define TARGET_MULTIPLE_STLD_P(target_flags) ((target_flags & MASK_MULTIPLE_STLD) != 0)
#define TARGET_PUSHPOP ((target_flags & MASK_PUSHPOP) != 0)
#define TARGET_PUSHPOP_P(target_flags) ((target_flags & MASK_PUSHPOP) != 0)
#define TARGET_SMART ((target_flags & MASK_SMART) != 0)
#define TARGET_SMART_P(target_flags) ((target_flags & MASK_SMART) != 0)
#define TARGET_STACK_SIZE ((target_flags & MASK_STACK_SIZE) != 0)
#define TARGET_STACK_SIZE_P(target_flags) ((target_flags & MASK_STACK_SIZE) != 0)
#define TARGET_STRICT_ALIGNMENT ((target_flags & MASK_STRICT_ALIGNMENT) != 0)
#define TARGET_STRICT_ALIGNMENT_P(target_flags) ((target_flags & MASK_STRICT_ALIGNMENT) != 0)
#define TARGET_W_FIELD ((target_flags & MASK_W_FIELD) != 0)
#define TARGET_W_FIELD_P(target_flags) ((target_flags & MASK_W_FIELD) != 0)
...
enum opt_code
{
  ...
  OPT__mcache = 55,                          /* --mcache */
  /* OPT__mcoprocessor = 56, */              /* --mcoprocessor */
  OPT__mhard_tp = 57,                        /* --mhard-tp */
  /* OPT__mmultiple_processor = 58, */       /* --mmultiple-processor */
  /* OPT__no_canonical_prefixes = 59, */     /* --no-canonical-prefixes */
  /* OPT__no_integrated_cpp = 60, */         /* --no-integrated-cpp */
  /* OPT__no_line_commands = 61, */          /* --no-line-commands */
  /* OPT__no_standard_includes = 62, */      /* --no-standard-includes */
  /* OPT__no_standard_libraries = 63, */     /* --no-standard-libraries */
  OPT__no_sysroot_suffix = 64,               /* --no-sysroot-suffix */
  /* OPT__no_warnings = 65, */               /* --no-warnings */
  /* OPT__optimize = 66, */                  /* --optimize */
  /* OPT__output = 67, */                    /* --output */
  /* OPT__output_class_directory = 68, */    /* --output-class-directory */
  /* OPT__output_class_directory_ = 69, */   /* --output-class-directory= */
  OPT__output_pch_ = 70,                     /* --output-pch= */
  /* OPT__output_ = 71, */                   /* --output= */
  OPT__param = 72,                           /* --param */
  /* OPT__param_ = 73, */                    /* --param= */
  /* OPT__pass_exit_codes = 74, */           /* --pass-exit-codes */
  /* OPT__pedantic = 75, */                  /* --pedantic */
  /* OPT__pedantic_errors = 76, */           /* --pedantic-errors */
  /* OPT__pie = 77, */                       /* --pie */
  /* OPT__pipe = 78, */                      /* --pipe */
  /* OPT__prefix = 79, */                    /* --prefix */
  /* OPT__prefix_ = 80, */                   /* --prefix= */
  /* OPT__preprocess = 81, */                /* --preprocess */
  /* OPT__print_file_name = 82, */           /* --print-file-name */
  /* OPT__print_file_name_ = 83, */          /* --print-file-name= */
  /* OPT__print_libgcc_file_name = 84, */    /* --print-libgcc-file-name */
  /* OPT__print_missing_file_dependencies = 85, *//* --print-missing-file-dependencies */
  /* OPT__print_multi_directory = 86, */     /* --print-multi-directory */
  /* OPT__print_multi_lib = 87, */           /* --print-multi-lib */
  /* OPT__print_multi_os_directory = 88, */  /* --print-multi-os-directory */
  /* OPT__print_multiarch = 89, */           /* --print-multiarch */
  /* OPT__print_prog_name = 90, */           /* --print-prog-name */
  /* OPT__print_prog_name_ = 91, */          /* --print-prog-name= */
  /* OPT__print_search_dirs = 92, */         /* --print-search-dirs */
  /* OPT__print_sysroot = 93, */             /* --print-sysroot */
  /* OPT__print_sysroot_headers_suffix = 94, *//* --print-sysroot-headers-suffix */
  /* OPT__profile = 95, */                   /* --profile */
  /* OPT__resource = 96, */                  /* --resource */
  /* OPT__resource_ = 97, */                 /* --resource= */
  /* OPT__save_temps = 98, */                /* --save-temps */
  /* OPT__shared = 99, */                    /* --shared */
  /* OPT__specs = 100, */                    /* --specs */
  /* OPT__specs_ = 101, */                   /* --specs= */
  /* OPT__static = 102, */                   /* --static */
  /* OPT__symbolic = 103, */                 /* --symbolic */
  /* OPT__sysroot = 104, */                  /* --sysroot */
  OPT__sysroot_ = 105,                       /* --sysroot= */
  OPT__target_help = 106,                    /* --target-help */
  /* OPT__time = 107, */                     /* --time */
  /* OPT__trace_includes = 108, */           /* --trace-includes */
  /* OPT__traditional = 109, */              /* --traditional */
  /* OPT__traditional_cpp = 110, */          /* --traditional-cpp */
  /* OPT__trigraphs = 111, */                /* --trigraphs */
  /* OPT__undefine_macro = 112, */           /* --undefine-macro */
  /* OPT__undefine_macro_ = 113, */          /* --undefine-macro= */
  /* OPT__user_dependencies = 114, */        /* --user-dependencies */
  /* OPT__verbose = 115, */                  /* --verbose */
  OPT__version = 116,                        /* --version */
  /* OPT__write_dependencies = 117, */       /* --write-dependencies */
  /* OPT__write_user_dependencies = 118, */  /* --write-user-dependencies */
  OPT_A = 119,                               /* -A */
  OPT_B = 120,                               /* -B */
  OPT_C = 121,                               /* -C */
  OPT_CC = 122,                              /* -CC */
  /* OPT_CLASSPATH = 123, */                 /* -CLASSPATH */
  OPT_D = 124,                               /* -D */
  OPT_E = 125,                               /* -E */
  /* OPT_EB = 126, */                        /* -EB */
  /* OPT_EL = 127, */                        /* -EL */
  ...
  OPT_Tbss_ = 157,                           /* -Tbss= */
  OPT_Tdata = 158,                           /* -Tdata */
  OPT_Tdata_ = 159,                          /* -Tdata= */
  OPT_Ttext = 160,                           /* -Ttext */
  OPT_Ttext_ = 161,                          /* -Ttext= */
  OPT_U = 162,                               /* -U */
  /* OPT_W = 163, */                         /* -W */
  OPT_Wa_ = 164,                             /* -Wa, */
  OPT_Wabi = 165,                            /* -Wabi */
  OPT_Wabi_tag = 166,                        /* -Wabi-tag */
  OPT_Wabi_ = 167,                           /* -Wabi= */
  OPT_Waddress = 168,                        /* -Waddress */
  OPT_Waggregate_return = 169,               /* -Waggregate-return */
  OPT_Waggressive_loop_optimizations = 170,  /* -Waggressive-loop-optimizations */
  OPT_Waliasing = 171,                       /* -Waliasing */
  OPT_Walign_commons = 172,                  /* -Walign-commons */
  OPT_Wall = 173,                            /* -Wall */
  OPT_Wall_deprecation = 174,                /* -Wall-deprecation */
  OPT_Wall_javadoc = 175,                    /* -Wall-javadoc */
  OPT_Wampersand = 176,                      /* -Wampersand */
  OPT_Warray_bounds = 177,                   /* -Warray-bounds */
  OPT_Warray_bounds_ = 178,                  /* -Warray-bounds= */
  OPT_Warray_temporaries = 179,              /* -Warray-temporaries */
  OPT_Wassert_identifier = 180,              /* -Wassert-identifier */
  OPT_Wassign_intercept = 181,               /* -Wassign-intercept */
  OPT_Wattributes = 182,                     /* -Wattributes */
  OPT_Wbad_function_cast = 183,              /* -Wbad-function-cast */
  OPT_Wbool_compare = 184,                   /* -Wbool-compare */
  OPT_Wboxing = 185,                         /* -Wboxing */
  OPT_Wbuiltin_macro_redefined = 186,        /* -Wbuiltin-macro-redefined */
  OPT_Wc___compat = 187,                     /* -Wc++-compat */
  /* OPT_Wc__0x_compat = 188, */             /* -Wc++0x-compat */
  OPT_Wc__11_compat = 189,                   /* -Wc++11-compat */
  OPT_Wc__14_compat = 190,                   /* -Wc++14-compat */
  OPT_Wc_binding_type = 191,                 /* -Wc-binding-type */
  OPT_Wc90_c99_compat = 192,                 /* -Wc90-c99-compat */
  OPT_Wc99_c11_compat = 193,                 /* -Wc99-c11-compat */
  OPT_Wcast_align = 194,                     /* -Wcast-align */
  OPT_Wcast_qual = 195,                      /* -Wcast-qual */
  OPT_Wchar_concat = 196,                    /* -Wchar-concat */
  OPT_Wchar_subscripts = 197,                /* -Wchar-subscripts */
  OPT_Wcharacter_truncation = 198,           /* -Wcharacter-truncation */
  OPT_Wchkp = 199,                           /* -Wchkp */
  OPT_Wclobbered = 200,                      /* -Wclobbered */
  OPT_Wcomment = 201,                        /* -Wcomment */
  /* OPT_Wcomments = 202, */                 /* -Wcomments */
  OPT_Wcompare_reals = 203,                  /* -Wcompare-reals */
  OPT_Wcondition_assign = 204,               /* -Wcondition-assign */
  OPT_Wconditionally_supported = 205,        /* -Wconditionally-supported */
  OPT_Wconstructor_name = 206,               /* -Wconstructor-name */
  OPT_Wconversion = 207,                     /* -Wconversion */
  OPT_Wconversion_extra = 208,               /* -Wconversion-extra */
  OPT_Wconversion_null = 209,                /* -Wconversion-null */
  OPT_Wcoverage_mismatch = 210,              /* -Wcoverage-mismatch */
  OPT_Wcpp = 211,                            /* -Wcpp */
  OPT_Wctor_dtor_privacy = 212,              /* -Wctor-dtor-privacy */
  OPT_Wdate_time = 213,                      /* -Wdate-time */
  OPT_Wdeclaration_after_statement = 214,    /* -Wdeclaration-after-statement */
  OPT_Wdelete_incomplete = 215,              /* -Wdelete-incomplete */
  OPT_Wdelete_non_virtual_dtor = 216,        /* -Wdelete-non-virtual-dtor */
  OPT_Wdep_ann = 217,                        /* -Wdep-ann */
  OPT_Wdeprecated = 218,                     /* -Wdeprecated */
  OPT_Wdeprecated_declarations = 219,        /* -Wdeprecated-declarations */
  OPT_Wdesignated_init = 220,                /* -Wdesignated-init */
  OPT_Wdisabled_optimization = 221,          /* -Wdisabled-optimization */
  OPT_Wdiscarded_array_qualifiers = 222,     /* -Wdiscarded-array-qualifiers */
  OPT_Wdiscarded_qualifiers = 223,           /* -Wdiscarded-qualifiers */
  OPT_Wdiscouraged = 224,                    /* -Wdiscouraged */
  OPT_Wdiv_by_zero = 225,                    /* -Wdiv-by-zero */
  OPT_Wdouble_promotion = 226,               /* -Wdouble-promotion */
  OPT_Wduplicated_cond = 227,                /* -Wduplicated-cond */
  OPT_Weffc__ = 228,                         /* -Weffc++ */
  OPT_Wempty_block = 229,                    /* -Wempty-block */
  OPT_Wempty_body = 230,                     /* -Wempty-body */
  OPT_Wendif_labels = 231,                   /* -Wendif-labels */
  OPT_Wenum_compare = 232,                   /* -Wenum-compare */
  OPT_Wenum_identifier = 233,                /* -Wenum-identifier */
  OPT_Wenum_switch = 234,                    /* -Wenum-switch */
  OPT_Werror = 235,                          /* -Werror */
  /* OPT_Werror_implicit_function_declaration = 236, *//* -Werror-implicit-function-declaration */
  OPT_Werror_ = 237,                         /* -Werror= */
  OPT_Wextra = 238,                          /* -Wextra */
  OPT_Wextraneous_semicolon = 239,           /* -Wextraneous-semicolon */
  OPT_Wfallthrough = 240,                    /* -Wfallthrough */
  OPT_Wfatal_errors = 241,                   /* -Wfatal-errors */
  OPT_Wfield_hiding = 242,                   /* -Wfield-hiding */
  OPT_Wfinal_bound = 243,                    /* -Wfinal-bound */
  OPT_Wfinally = 244,                        /* -Wfinally */
  OPT_Wfloat_conversion = 245,               /* -Wfloat-conversion */
  OPT_Wfloat_equal = 246,                    /* -Wfloat-equal */
  OPT_Wforbidden = 247,                      /* -Wforbidden */
  /* OPT_Wformat = 248, */                   /* -Wformat */
  OPT_Wformat_contains_nul = 249,            /* -Wformat-contains-nul */
  OPT_Wformat_extra_args = 250,              /* -Wformat-extra-args */
  OPT_Wformat_nonliteral = 251,              /* -Wformat-nonliteral */
  OPT_Wformat_security = 252,                /* -Wformat-security */
  OPT_Wformat_signedness = 253,              /* -Wformat-signedness */
  OPT_Wformat_y2k = 254,                     /* -Wformat-y2k */
  OPT_Wformat_zero_length = 255,             /* -Wformat-zero-length */
  OPT_Wformat_ = 256,                        /* -Wformat= */
  OPT_Wframe_address = 257,                  /* -Wframe-address */
  OPT_Wframe_larger_than_ = 258,             /* -Wframe-larger-than= */
  OPT_Wfree_nonheap_object = 259,            /* -Wfree-nonheap-object */
  OPT_Wfunction_elimination = 260,           /* -Wfunction-elimination */
  OPT_Whiding = 261,                         /* -Whiding */
  OPT_Whsa = 262,                            /* -Whsa */
  OPT_Wignored_attributes = 263,             /* -Wignored-attributes */
  OPT_Wignored_qualifiers = 264,             /* -Wignored-qualifiers */
  OPT_Wimplicit = 265,                       /* -Wimplicit */
  OPT_Wimplicit_function_declaration = 266,  /* -Wimplicit-function-declaration */
  OPT_Wimplicit_int = 267,                   /* -Wimplicit-int */
  OPT_Wimplicit_interface = 268,             /* -Wimplicit-interface */
  OPT_Wimplicit_procedure = 269,             /* -Wimplicit-procedure */
  /* OPT_Wimport = 270, */                   /* -Wimport */
  OPT_Wincompatible_pointer_types = 271,     /* -Wincompatible-pointer-types */
  OPT_Windirect_static = 272,                /* -Windirect-static */
  OPT_Winherited_variadic_ctor = 273,        /* -Winherited-variadic-ctor */
  OPT_Winit_self = 274,                      /* -Winit-self */
  OPT_Winline = 275,                         /* -Winline */
  OPT_Wint_conversion = 276,                 /* -Wint-conversion */
  OPT_Wint_to_pointer_cast = 277,            /* -Wint-to-pointer-cast */
  OPT_Winteger_division = 278,               /* -Winteger-division */
  OPT_Wintf_annotation = 279,                /* -Wintf-annotation */
  OPT_Wintf_non_inherited = 280,             /* -Wintf-non-inherited */
  OPT_Wintrinsic_shadow = 281,               /* -Wintrinsic-shadow */
  OPT_Wintrinsics_std = 282,                 /* -Wintrinsics-std */
  OPT_Winvalid_memory_model = 283,           /* -Winvalid-memory-model */
  OPT_Winvalid_offsetof = 284,               /* -Winvalid-offsetof */
  OPT_Winvalid_pch = 285,                    /* -Winvalid-pch */
  OPT_Wjavadoc = 286,                        /* -Wjavadoc */
  OPT_Wjump_misses_init = 287,               /* -Wjump-misses-init */
  OPT_Wl_ = 288,                             /* -Wl, */
  /* OPT_Wlarger_than_ = 289, */             /* -Wlarger-than- */
  OPT_Wlarger_than_ = 290,                   /* -Wlarger-than= */
  OPT_Wline_truncation = 291,                /* -Wline-truncation */
  OPT_Wliteral_suffix = 292,                 /* -Wliteral-suffix */
  OPT_Wlocal_hiding = 293,                   /* -Wlocal-hiding */
  OPT_Wlogical_not_parentheses = 294,        /* -Wlogical-not-parentheses */
  OPT_Wlogical_op = 295,                     /* -Wlogical-op */
  OPT_Wlong_long = 296,                      /* -Wlong-long */
  OPT_Wlto_type_mismatch = 297,              /* -Wlto-type-mismatch */
  OPT_Wmain = 298,                           /* -Wmain */
  OPT_Wmasked_catch_block = 299,             /* -Wmasked-catch-block */
  OPT_Wmaybe_uninitialized = 300,            /* -Wmaybe-uninitialized */
  OPT_Wmemset_transposed_args = 301,         /* -Wmemset-transposed-args */
  OPT_Wmisleading_indentation = 302,         /* -Wmisleading-indentation */
  OPT_Wmissing_braces = 303,                 /* -Wmissing-braces */
  OPT_Wmissing_declarations = 304,           /* -Wmissing-declarations */
  OPT_Wmissing_field_initializers = 305,     /* -Wmissing-field-initializers */
  /* OPT_Wmissing_format_attribute = 306, */ /* -Wmissing-format-attribute */
  OPT_Wmissing_include_dirs = 307,           /* -Wmissing-include-dirs */
  /* OPT_Wmissing_noreturn = 308, */         /* -Wmissing-noreturn */
  OPT_Wmissing_parameter_type = 309,         /* -Wmissing-parameter-type */
  OPT_Wmissing_prototypes = 310,             /* -Wmissing-prototypes */
  /* OPT_Wmudflap = 311, */                  /* -Wmudflap */
  OPT_Wmultichar = 312,                      /* -Wmultichar */
  OPT_Wmultiple_inheritance = 313,           /* -Wmultiple-inheritance */
  OPT_Wnamespaces = 314,                     /* -Wnamespaces */
  OPT_Wnarrowing = 315,                      /* -Wnarrowing */
  OPT_Wnested_externs = 316,                 /* -Wnested-externs */
  OPT_Wnls = 317,                            /* -Wnls */
  OPT_Wno_effect_assign = 318,               /* -Wno-effect-assign */
  OPT_Wnoexcept = 319,                       /* -Wnoexcept */
  OPT_Wnon_template_friend = 320,            /* -Wnon-template-friend */
  OPT_Wnon_virtual_dtor = 321,               /* -Wnon-virtual-dtor */
  OPT_Wnonnull = 322,                        /* -Wnonnull */
  OPT_Wnonnull_compare = 323,                /* -Wnonnull-compare */
  /* OPT_Wnormalized = 324, */               /* -Wnormalized */
  OPT_Wnormalized_ = 325,                    /* -Wnormalized= */
  OPT_Wnull = 326,                           /* -Wnull */
  OPT_Wnull_dereference = 327,               /* -Wnull-dereference */
  OPT_Wodr = 328,                            /* -Wodr */
  OPT_Wold_style_cast = 329,                 /* -Wold-style-cast */
  OPT_Wold_style_declaration = 330,          /* -Wold-style-declaration */
  OPT_Wold_style_definition = 331,           /* -Wold-style-definition */
  OPT_Wopenmp_simd = 332,                    /* -Wopenmp-simd */
  OPT_Wout_of_date = 333,                    /* -Wout-of-date */
  OPT_Wover_ann = 334,                       /* -Wover-ann */
  OPT_Woverflow = 335,                       /* -Woverflow */
  OPT_Woverlength_strings = 336,             /* -Woverlength-strings */
  OPT_Woverloaded_virtual = 337,             /* -Woverloaded-virtual */
  OPT_Woverride_init = 338,                  /* -Woverride-init */
  OPT_Woverride_init_side_effects = 339,     /* -Woverride-init-side-effects */
  OPT_Wp_ = 340,                             /* -Wp, */
  OPT_Wpacked = 341,                         /* -Wpacked */
  OPT_Wpacked_bitfield_compat = 342,         /* -Wpacked-bitfield-compat */
  OPT_Wpadded = 343,                         /* -Wpadded */
  OPT_Wparam_assign = 344,                   /* -Wparam-assign */
  OPT_Wparentheses = 345,                    /* -Wparentheses */
  OPT_Wpedantic = 346,                       /* -Wpedantic */
  OPT_Wpkg_default_method = 347,             /* -Wpkg-default-method */
  /* OPT_Wplacement_new = 348, */            /* -Wplacement-new */
  OPT_Wplacement_new_ = 349,                 /* -Wplacement-new= */
  OPT_Wpmf_conversions = 350,                /* -Wpmf-conversions */
  OPT_Wpointer_arith = 351,                  /* -Wpointer-arith */
  OPT_Wpointer_sign = 352,                   /* -Wpointer-sign */
  OPT_Wpointer_to_int_cast = 353,            /* -Wpointer-to-int-cast */
  OPT_Wpragmas = 354,                        /* -Wpragmas */
  OPT_Wproperty_assign_default = 355,        /* -Wproperty-assign-default */
  OPT_Wprotocol = 356,                       /* -Wprotocol */
  OPT_Wpsabi = 357,                          /* -Wpsabi */
  OPT_Wraw = 358,                            /* -Wraw */
  OPT_Wreal_q_constant = 359,                /* -Wreal-q-constant */
  OPT_Wrealloc_lhs = 360,                    /* -Wrealloc-lhs */
  OPT_Wrealloc_lhs_all = 361,                /* -Wrealloc-lhs-all */
  OPT_Wredundant_decls = 362,                /* -Wredundant-decls */
  OPT_Wredundant_modifiers = 363,            /* -Wredundant-modifiers */
  OPT_Wreorder = 364,                        /* -Wreorder */
  OPT_Wreturn_local_addr = 365,              /* -Wreturn-local-addr */
  OPT_Wreturn_type = 366,                    /* -Wreturn-type */
  OPT_Wscalar_storage_order = 367,           /* -Wscalar-storage-order */
  OPT_Wselector = 368,                       /* -Wselector */
  OPT_Wsequence_point = 369,                 /* -Wsequence-point */
  OPT_Wserial = 370,                         /* -Wserial */
  OPT_Wshadow = 371,                         /* -Wshadow */
  OPT_Wshadow_ivar = 372,                    /* -Wshadow-ivar */
  OPT_Wshift_count_negative = 373,           /* -Wshift-count-negative */
  OPT_Wshift_count_overflow = 374,           /* -Wshift-count-overflow */
  OPT_Wshift_negative_value = 375,           /* -Wshift-negative-value */
  /* OPT_Wshift_overflow = 376, */           /* -Wshift-overflow */
  OPT_Wshift_overflow_ = 377,                /* -Wshift-overflow= */
  OPT_Wsign_compare = 378,                   /* -Wsign-compare */
  OPT_Wsign_conversion = 379,                /* -Wsign-conversion */
  OPT_Wsign_promo = 380,                     /* -Wsign-promo */
  OPT_Wsized_deallocation = 381,             /* -Wsized-deallocation */
  OPT_Wsizeof_array_argument = 382,          /* -Wsizeof-array-argument */
  OPT_Wsizeof_pointer_memaccess = 383,       /* -Wsizeof-pointer-memaccess */
  OPT_Wspecial_param_hiding = 384,           /* -Wspecial-param-hiding */
  OPT_Wstack_protector = 385,                /* -Wstack-protector */
  OPT_Wstack_usage_ = 386,                   /* -Wstack-usage= */
  OPT_Wstatic_access = 387,                  /* -Wstatic-access */
  OPT_Wstatic_receiver = 388,                /* -Wstatic-receiver */
  OPT_Wstrict_aliasing = 389,                /* -Wstrict-aliasing */
  OPT_Wstrict_aliasing_ = 390,               /* -Wstrict-aliasing= */
  OPT_Wstrict_null_sentinel = 391,           /* -Wstrict-null-sentinel */
  OPT_Wstrict_overflow = 392,                /* -Wstrict-overflow */
  OPT_Wstrict_overflow_ = 393,               /* -Wstrict-overflow= */
  OPT_Wstrict_prototypes = 394,              /* -Wstrict-prototypes */
  OPT_Wstrict_selector_match = 395,          /* -Wstrict-selector-match */
  OPT_Wsubobject_linkage = 396,              /* -Wsubobject-linkage */
  OPT_Wsuggest_attribute_const = 397,        /* -Wsuggest-attribute=const */
  OPT_Wsuggest_attribute_format = 398,       /* -Wsuggest-attribute=format */
  OPT_Wsuggest_attribute_noreturn = 399,     /* -Wsuggest-attribute=noreturn */
  OPT_Wsuggest_attribute_pure = 400,         /* -Wsuggest-attribute=pure */
  OPT_Wsuggest_final_methods = 401,          /* -Wsuggest-final-methods */
  OPT_Wsuggest_final_types = 402,            /* -Wsuggest-final-types */
  OPT_Wsuggest_override = 403,               /* -Wsuggest-override */
  OPT_Wsuppress = 404,                       /* -Wsuppress */
  ...
  OPT_Wsync_nand = 410,                      /* -Wsync-nand */
  OPT_Wsynth = 411,                          /* -Wsynth */
  OPT_Wsynthetic_access = 412,               /* -Wsynthetic-access */
  OPT_Wsystem_headers = 413,                 /* -Wsystem-headers */
  OPT_Wtabs = 414,                           /* -Wtabs */
  OPT_Wtarget_lifetime = 415,                /* -Wtarget-lifetime */
  OPT_Wtasks = 416,                          /* -Wtasks */
  OPT_Wtautological_compare = 417,           /* -Wtautological-compare */
  OPT_Wtemplates = 418,                      /* -Wtemplates */
  OPT_Wterminate = 419,                      /* -Wterminate */
  OPT_Wtraditional = 420,                    /* -Wtraditional */
  OPT_Wtraditional_conversion = 421,         /* -Wtraditional-conversion */
  OPT_Wtrampolines = 422,                    /* -Wtrampolines */
  OPT_Wtrigraphs = 423,                      /* -Wtrigraphs */
  OPT_Wtype_hiding = 424,                    /* -Wtype-hiding */
  OPT_Wtype_limits = 425,                    /* -Wtype-limits */
  OPT_Wuncheck = 426,                        /* -Wuncheck */
  OPT_Wundeclared_selector = 427,            /* -Wundeclared-selector */
  OPT_Wundef = 428,                          /* -Wundef */
  OPT_Wunderflow = 429,                      /* -Wunderflow */
  OPT_Wuninitialized = 430,                  /* -Wuninitialized */
  OPT_Wunknown_pragmas = 431,                /* -Wunknown-pragmas */
  OPT_Wunnecessary_else = 432,               /* -Wunnecessary-else */
  OPT_Wunqualified_field = 433,              /* -Wunqualified-field */
  /* OPT_Wunreachable_code = 434, */         /* -Wunreachable-code */
  OPT_Wunsafe_loop_optimizations = 435,      /* -Wunsafe-loop-optimizations */
  OPT_Wunsuffixed_float_constants = 436,     /* -Wunsuffixed-float-constants */
  OPT_Wunused = 437,                         /* -Wunused */
  OPT_Wunused_argument = 438,                /* -Wunused-argument */
  OPT_Wunused_but_set_parameter = 439,       /* -Wunused-but-set-parameter */
  OPT_Wunused_but_set_variable = 440,        /* -Wunused-but-set-variable */
  /* OPT_Wunused_const_variable = 441, */    /* -Wunused-const-variable */
  OPT_Wunused_const_variable_ = 442,         /* -Wunused-const-variable= */
  OPT_Wunused_dummy_argument = 443,          /* -Wunused-dummy-argument */
  OPT_Wunused_function = 444,                /* -Wunused-function */
  OPT_Wunused_import = 445,                  /* -Wunused-import */
  OPT_Wunused_label = 446,                   /* -Wunused-label */
  OPT_Wunused_local = 447,                   /* -Wunused-local */
  OPT_Wunused_local_typedefs = 448,          /* -Wunused-local-typedefs */
  OPT_Wunused_macros = 449,                  /* -Wunused-macros */
  OPT_Wunused_parameter = 450,               /* -Wunused-parameter */
  OPT_Wunused_private = 451,                 /* -Wunused-private */
  OPT_Wunused_result = 452,                  /* -Wunused-result */
  OPT_Wunused_thrown = 453,                  /* -Wunused-thrown */
  OPT_Wunused_value = 454,                   /* -Wunused-value */
  OPT_Wunused_variable = 455,                /* -Wunused-variable */
  OPT_Wuse_without_only = 456,               /* -Wuse-without-only */
  OPT_Wuseless_cast = 457,                   /* -Wuseless-cast */
  OPT_Wuseless_type_check = 458,             /* -Wuseless-type-check */
  OPT_Wvarargs = 459,                        /* -Wvarargs */
  OPT_Wvarargs_cast = 460,                   /* -Wvarargs-cast */
  OPT_Wvariadic_macros = 461,                /* -Wvariadic-macros */
  OPT_Wvector_operation_performance = 462,   /* -Wvector-operation-performance */
  OPT_Wvirtual_inheritance = 463,            /* -Wvirtual-inheritance */
  OPT_Wvirtual_move_assign = 464,            /* -Wvirtual-move-assign */
  OPT_Wvla = 465,                            /* -Wvla */
  OPT_Wvolatile_register_var = 466,          /* -Wvolatile-register-var */
  OPT_Wwarning_token = 467,                  /* -Wwarning-token */
  OPT_Wwrite_strings = 468,                  /* -Wwrite-strings */
  OPT_Wzero_as_null_pointer_constant = 469,  /* -Wzero-as-null-pointer-constant */
  OPT_Wzerotrip = 470,                       /* -Wzerotrip */
  OPT_Xassembler = 471,                      /* -Xassembler */
  OPT_Xlinker = 472,                         /* -Xlinker */
  OPT_Xpreprocessor = 473,                   /* -Xpreprocessor */
  OPT_Z = 474,                               /* -Z */
  OPT_ansi = 475,                            /* -ansi */
  OPT_aux_info = 476,                        /* -aux-info */
  /* OPT_aux_info_ = 477, */                 /* -aux-info= */
  OPT_auxbase = 478,                         /* -auxbase */
  OPT_auxbase_strip = 479,                   /* -auxbase-strip */
  /* OPT_bootclasspath = 480, */             /* -bootclasspath */
  OPT_c = 481,                               /* -c */
  ...
  OPT_fcse_cc = 599,                         /* -fcse-cc */
  OPT_fcse_follow_jumps = 600,               /* -fcse-follow-jumps */
  /* OPT_fcse_skip_blocks = 601, */          /* -fcse-skip-blocks */
  OPT_fcx_fortran_rules = 602,               /* -fcx-fortran-rules */
  OPT_fcx_limited_range = 603,               /* -fcx-limited-range */
  OPT_fd_lines_as_code = 604,                /* -fd-lines-as-code */
  OPT_fd_lines_as_comments = 605,            /* -fd-lines-as-comments */
  ...
  OPT_frounding_math = 949,                  /* -frounding-math */
  OPT_frtti = 950,                           /* -frtti */
  OPT_fsanitize_coverage_trace_pc = 951,     /* -fsanitize-coverage=trace-pc */
  OPT_fsanitize_recover = 952,               /* -fsanitize-recover */
  OPT_fsanitize_recover_ = 953,              /* -fsanitize-recover= */
  OPT_fsanitize_sections_ = 954,             /* -fsanitize-sections= */
  OPT_fsanitize_undefined_trap_on_error = 955,/* -fsanitize-undefined-trap-on-error */
  OPT_fsanitize_ = 956,                      /* -fsanitize= */
  OPT_fsaw_java_file = 957,                  /* -fsaw-java-file */
  OPT_fsched_critical_path_heuristic = 958,  /* -fsched-critical-path-heuristic */
  OPT_fsched_dep_count_heuristic = 959,      /* -fsched-dep-count-heuristic */
  OPT_fsched_group_heuristic = 960,          /* -fsched-group-heuristic */
  OPT_fsched_interblock = 961,               /* -fsched-interblock */
  OPT_fsched_last_insn_heuristic = 962,      /* -fsched-last-insn-heuristic */
  OPT_fsched_pressure = 963,                 /* -fsched-pressure */
  OPT_fsched_prolog = 964,                   /* -fsched-prolog */
  ...
  OPT_fsync_libcalls = 1032,                 /* -fsync-libcalls */
  OPT_fsyntax_only = 1033,                   /* -fsyntax-only */
  OPT_ftabstop_ = 1034,                      /* -ftabstop= */
  /* OPT_ftarget_help = 1035, */             /* -ftarget-help */
  OPT_ftarget_ = 1036,                       /* -ftarget= */
  OPT_ftemplate_backtrace_limit_ = 1037,     /* -ftemplate-backtrace-limit= */
  /* OPT_ftemplate_depth_ = 1038, */         /* -ftemplate-depth- */
  OPT_ftemplate_depth_ = 1039,               /* -ftemplate-depth= */
  OPT_ftest_coverage = 1040,                 /* -ftest-coverage */
  /* OPT_fthis_is_variable = 1041, */        /* -fthis-is-variable */
  OPT_fthread_jumps = 1042,                  /* -fthread-jumps */
  OPT_fthreadsafe_statics = 1043,            /* -fthreadsafe-statics */
  OPT_ftime_report = 1044,                   /* -ftime-report */
  OPT_ftls_model_ = 1045,                    /* -ftls-model= */
  OPT_ftoplevel_reorder = 1046,              /* -ftoplevel-reorder */
  OPT_ftracer = 1047,                        /* -ftracer */
  OPT_ftrack_macro_expansion = 1048,         /* -ftrack-macro-expansion */
  OPT_ftrack_macro_expansion_ = 1049,        /* -ftrack-macro-expansion= */
  OPT_ftrapping_math = 1050,                 /* -ftrapping-math */
  OPT_ftrapv = 1051,                         /* -ftrapv */
  OPT_ftree_bit_ccp = 1052,                  /* -ftree-bit-ccp */
  OPT_ftree_builtin_call_dce = 1053,         /* -ftree-builtin-call-dce */
  OPT_ftree_ccp = 1054,                      /* -ftree-ccp */
  OPT_ftree_ch = 1055,                       /* -ftree-ch */
  /* OPT_ftree_coalesce_inlined_vars = 1056, *//* -ftree-coalesce-inlined-vars */
  OPT_ftree_coalesce_vars = 1057,            /* -ftree-coalesce-vars */
  OPT_ftree_copy_prop = 1058,                /* -ftree-copy-prop */
  /* OPT_ftree_copyrename = 1059, */         /* -ftree-copyrename */
  OPT_ftree_cselim = 1060,                   /* -ftree-cselim */
  OPT_ftree_dce = 1061,                      /* -ftree-dce */
  OPT_ftree_dominator_opts = 1062,           /* -ftree-dominator-opts */
  OPT_ftree_dse = 1063,                      /* -ftree-dse */
  OPT_ftree_forwprop = 1064,                 /* -ftree-forwprop */
  OPT_ftree_fre = 1065,                      /* -ftree-fre */
  OPT_ftree_loop_distribute_patterns = 1066, /* -ftree-loop-distribute-patterns */
  OPT_ftree_loop_distribution = 1067,        /* -ftree-loop-distribution */
  OPT_ftree_loop_if_convert = 1068,          /* -ftree-loop-if-convert */
  OPT_ftree_loop_if_convert_stores = 1069,   /* -ftree-loop-if-convert-stores */
  OPT_ftree_loop_im = 1070,                  /* -ftree-loop-im */
  OPT_ftree_loop_ivcanon = 1071,             /* -ftree-loop-ivcanon */
  /* OPT_ftree_loop_linear = 1072, */        /* -ftree-loop-linear */
  OPT_ftree_loop_optimize = 1073,            /* -ftree-loop-optimize */
  OPT_ftree_loop_vectorize = 1074,           /* -ftree-loop-vectorize */
  OPT_ftree_lrs = 1075,                      /* -ftree-lrs */
  OPT_ftree_parallelize_loops_ = 1076,       /* -ftree-parallelize-loops= */
  OPT_ftree_partial_pre = 1077,              /* -ftree-partial-pre */
  OPT_ftree_phiprop = 1078,                  /* -ftree-phiprop */
  OPT_ftree_pre = 1079,                      /* -ftree-pre */
  OPT_ftree_pta = 1080,                      /* -ftree-pta */
  OPT_ftree_reassoc = 1081,                  /* -ftree-reassoc */
  /* OPT_ftree_salias = 1082, */             /* -ftree-salias */
  OPT_ftree_scev_cprop = 1083,               /* -ftree-scev-cprop */
  OPT_ftree_sink = 1084,                     /* -ftree-sink */
  OPT_ftree_slp_vectorize = 1085,            /* -ftree-slp-vectorize */
  OPT_ftree_slsr = 1086,                     /* -ftree-slsr */
  OPT_ftree_sra = 1087,                      /* -ftree-sra */
  /* OPT_ftree_store_ccp = 1088, */          /* -ftree-store-ccp */
  /* OPT_ftree_store_copy_prop = 1089, */    /* -ftree-store-copy-prop */
  OPT_ftree_switch_conversion = 1090,        /* -ftree-switch-conversion */
  OPT_ftree_tail_merge = 1091,               /* -ftree-tail-merge */
  OPT_ftree_ter = 1092,                      /* -ftree-ter */
  /* OPT_ftree_vect_loop_version = 1093, */  /* -ftree-vect-loop-version */
  OPT_ftree_vectorize = 1094,                /* -ftree-vectorize */
  /* OPT_ftree_vectorizer_verbose_ = 1095, *//* -ftree-vectorizer-verbose= */
  OPT_ftree_vrp = 1096,                      /* -ftree-vrp */
  OPT_funconstrained_commons = 1097,         /* -funconstrained-commons */
  OPT_funderscoring = 1098,                  /* -funderscoring */
  OPT_funit_at_a_time = 1099,                /* -funit-at-a-time */
  OPT_funroll_all_loops = 1100,              /* -funroll-all-loops */
  OPT_funroll_loops = 1101,                  /* -funroll-loops */
  OPT_funsafe_loop_optimizations = 1102,     /* -funsafe-loop-optimizations */
  OPT_funsafe_math_optimizations = 1103,     /* -funsafe-math-optimizations */
  OPT_funsigned_bitfields = 1104,            /* -funsigned-bitfields */
  OPT_funsigned_char = 1105,                 /* -funsigned-char */
  OPT_funswitch_loops = 1106,                /* -funswitch-loops */
  OPT_funwind_tables = 1107,                 /* -funwind-tables */
  OPT_fuse_atomic_builtins = 1108,           /* -fuse-atomic-builtins */
  OPT_fuse_boehm_gc = 1109,                  /* -fuse-boehm-gc */
  OPT_fuse_cxa_atexit = 1110,                /* -fuse-cxa-atexit */
  OPT_fuse_cxa_get_exception_ptr = 1111,     /* -fuse-cxa-get-exception-ptr */
  OPT_fuse_divide_subroutine = 1112,         /* -fuse-divide-subroutine */
  OPT_fuse_ld_bfd = 1113,                    /* -fuse-ld=bfd */
  OPT_fuse_ld_gold = 1114,                   /* -fuse-ld=gold */
  OPT_fuse_linker_plugin = 1115,             /* -fuse-linker-plugin */
  OPT_fvar_tracking = 1116,                  /* -fvar-tracking */
  OPT_fvar_tracking_assignments = 1117,      /* -fvar-tracking-assignments */
  OPT_fvar_tracking_assignments_toggle = 1118,/* -fvar-tracking-assignments-toggle */
  OPT_fvar_tracking_uninit = 1119,           /* -fvar-tracking-uninit */
  OPT_fvariable_expansion_in_unroller = 1120,/* -fvariable-expansion-in-unroller */
  /* OPT_fvect_cost_model = 1121, */         /* -fvect-cost-model */
  OPT_fvect_cost_model_ = 1122,              /* -fvect-cost-model= */
  OPT_fverbose_asm = 1123,                   /* -fverbose-asm */
  /* OPT_fversion = 1124, */                 /* -fversion */
  OPT_fvisibility_inlines_hidden = 1125,     /* -fvisibility-inlines-hidden */
  OPT_fvisibility_ms_compat = 1126,          /* -fvisibility-ms-compat */
  OPT_fvisibility_ = 1127,                   /* -fvisibility= */
  OPT_fvpt = 1128,                           /* -fvpt */
  /* OPT_fvtable_gc = 1129, */               /* -fvtable-gc */
  /* OPT_fvtable_thunks = 1130, */           /* -fvtable-thunks */
  OPT_fvtable_verify_ = 1131,                /* -fvtable-verify= */
  OPT_fvtv_counts = 1132,                    /* -fvtv-counts */
  OPT_fvtv_debug = 1133,                     /* -fvtv-debug */
  OPT_fweak = 1134,                          /* -fweak */
  OPT_fweb = 1135,                           /* -fweb */
  /* OPT_fwhole_file = 1136, */              /* -fwhole-file */
  OPT_fwhole_program = 1137,                 /* -fwhole-program */
  OPT_fwide_exec_charset_ = 1138,            /* -fwide-exec-charset= */
  OPT_fworking_directory = 1139,             /* -fworking-directory */
  OPT_fwpa = 1140,                           /* -fwpa */
  OPT_fwpa_ = 1141,                          /* -fwpa= */
  OPT_fwrapv = 1142,                         /* -fwrapv */
  /* OPT_fxref = 1143, */                    /* -fxref */
  /* OPT_fzee = 1144, */                     /* -fzee */
  OPT_fzero_initialized_in_bss = 1145,       /* -fzero-initialized-in-bss */
  OPT_fzero_link = 1146,                     /* -fzero-link */
  OPT_g = 1147,                              /* -g */
  OPT_gant = 1148,                           /* -gant */
  OPT_gcoff = 1149,                          /* -gcoff */
  ...
  OPT_gno_pubnames = 1157,                   /* -gno-pubnames */
  OPT_gno_record_gcc_switches = 1158,        /* -gno-record-gcc-switches */
  OPT_gno_split_dwarf = 1159,                /* -gno-split-dwarf */
  OPT_gno_strict_dwarf = 1160,               /* -gno-strict-dwarf */
  ...
  OPT_gstrict_dwarf = 1166,                  /* -gstrict-dwarf */
  OPT_gtoggle = 1167,                        /* -gtoggle */
  OPT_gvms = 1168,                           /* -gvms */
  OPT_gxcoff = 1169,                         /* -gxcoff */
  OPT_gxcoff_ = 1170,                        /* -gxcoff+ */
  OPT_gz = 1171,                             /* -gz */
  OPT_gz_ = 1172,                            /* -gz= */
  OPT_h = 1173,                              /* -h */
  OPT_idirafter = 1174,                      /* -idirafter */
  OPT_imacros = 1175,                        /* -imacros */
  OPT_imultiarch = 1176,                     /* -imultiarch */
  OPT_imultilib = 1177,                      /* -imultilib */
  OPT_include = 1178,                        /* -include */
  OPT_iplugindir_ = 1179,                    /* -iplugindir= */
  OPT_iprefix = 1180,                        /* -iprefix */
  OPT_iquote = 1181,                         /* -iquote */
  OPT_isysroot = 1182,                       /* -isysroot */
  OPT_isystem = 1183,                        /* -isystem */
  OPT_iwithprefix = 1184,                    /* -iwithprefix */
  OPT_iwithprefixbefore = 1185,              /* -iwithprefixbefore */
  OPT_k8 = 1186,                             /* -k8 */
  OPT_l = 1187,                              /* -l */
  OPT_lang_asm = 1188,                       /* -lang-asm */
  OPT_manchor = 1189,                        /* -manchor */
  OPT_march_ = 1190,                         /* -march= */
  OPT_march_ck803s = 1191,                   /* -march=ck803s */
  OPT_mbacktrace = 1192,                     /* -mbacktrace */
  OPT_mbig_endian = 1193,                    /* -mbig-endian */
  OPT_mbionic = 1194,                        /* -mbionic */
  OPT_mbranch_cost_ = 1195,                  /* -mbranch-cost= */
  OPT_mccrt = 1196,                          /* -mccrt */
  OPT_mconstpool = 1197,                     /* -mconstpool */
  OPT_mcp = 1198,                            /* -mcp */
  OPT_mcpu_ = 1199,                          /* -mcpu= */
  OPT_mdiv = 1200,                           /* -mdiv */
  OPT_mdouble_float = 1201,                  /* -mdouble-float */
  OPT_mdsp = 1202,                           /* -mdsp */
  OPT_medsp = 1203,                          /* -medsp */
  OPT_melrw = 1204,                          /* -melrw */
  OPT_mfdivdu = 1205,                        /* -mfdivdu */
  OPT_mfpu_ = 1206,                          /* -mfpu= */
  OPT_mglibc = 1207,                         /* -mglibc */
  OPT_mhard_float = 1208,                    /* -mhard-float */
  OPT_mhigh_registers = 1209,                /* -mhigh-registers */
  OPT_mistack = 1210,                        /* -mistack */
  OPT_mlittle_endian = 1211,                 /* -mlittle-endian */
  OPT_mmac = 1212,                           /* -mmac */
  OPT_mmp = 1213,                            /* -mmp */
  OPT_mmultiple_stld = 1214,                 /* -mmultiple-stld */
  OPT_mmusl = 1215,                          /* -mmusl */
  OPT_mpushpop = 1216,                       /* -mpushpop */
  OPT_msmart = 1217,                         /* -msmart */
  OPT_msoft_float = 1218,                    /* -msoft-float */
  OPT_mstack_size = 1219,                    /* -mstack-size */
  /* OPT_mstm = 1220, */                     /* -mstm */
  OPT_mstrict_align = 1221,                  /* -mstrict-align */
  OPT_mtrust = 1222,                         /* -mtrust */
  OPT_muclibc = 1223,                        /* -muclibc */
  OPT_mwide_bitfields = 1224,                /* -mwide-bitfields */
  OPT_n = 1225,                              /* -n */
  OPT_no_canonical_prefixes = 1226,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1227,              /* -no-integrated-cpp */
  OPT_no_pie = 1228,                         /* -no-pie */
  OPT_nocpp = 1229,                          /* -nocpp */
  OPT_nodefaultlibs = 1230,                  /* -nodefaultlibs */
  OPT_nostartfiles = 1231,                   /* -nostartfiles */
  OPT_nostdinc = 1232,                       /* -nostdinc */
  OPT_nostdinc__ = 1233,                     /* -nostdinc++ */
  OPT_nostdlib = 1234,                       /* -nostdlib */
  OPT_o = 1235,                              /* -o */
  OPT_p = 1236,                              /* -p */
  OPT_pass_exit_codes = 1237,                /* -pass-exit-codes */
  /* OPT_pedantic = 1238, */                 /* -pedantic */
  OPT_pedantic_errors = 1239,                /* -pedantic-errors */
  OPT_pg = 1240,                             /* -pg */
  OPT_pie = 1241,                            /* -pie */
  OPT_pipe = 1242,                           /* -pipe */
  OPT_posix = 1243,                          /* -posix */
  OPT_print_file_name_ = 1244,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1245,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1246,          /* -print-multi-directory */
  OPT_print_multi_lib = 1247,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1248,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1249,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1250,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1251,               /* -print-prog-name= */
  OPT_print_search_dirs = 1252,              /* -print-search-dirs */
  OPT_print_sysroot = 1253,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1254,   /* -print-sysroot-headers-suffix */
  OPT_profile = 1255,                        /* -profile */
  OPT_pthread = 1256,                        /* -pthread */
  OPT_quiet = 1257,                          /* -quiet */
  OPT_r = 1258,                              /* -r */
  OPT_rdynamic = 1259,                       /* -rdynamic */
  OPT_remap = 1260,                          /* -remap */
  OPT_s = 1261,                              /* -s */
  OPT_s_bc_abi = 1262,                       /* -s-bc-abi */
  OPT_save_temps = 1263,                     /* -save-temps */
  OPT_save_temps_ = 1264,                    /* -save-temps= */
  OPT_shared = 1265,                         /* -shared */
  OPT_shared_libgcc = 1266,                  /* -shared-libgcc */
  /* OPT_specs = 1267, */                    /* -specs */
  OPT_specs_ = 1268,                         /* -specs= */
  OPT_static = 1269,                         /* -static */
  OPT_static_libasan = 1270,                 /* -static-libasan */
  OPT_static_libgcc = 1271,                  /* -static-libgcc */
  OPT_static_libgcj = 1272,                  /* -static-libgcj */
  ...
  /* OPT_std_c__03 = 1281, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1282, */                /* -std=c++0x */
  OPT_std_c__11 = 1283,                      /* -std=c++11 */
  OPT_std_c__14 = 1284,                      /* -std=c++14 */
  /* OPT_std_c__17 = 1285, */                /* -std=c++17 */
  /* OPT_std_c__1y = 1286, */                /* -std=c++1y */
  OPT_std_c__1z = 1287,                      /* -std=c++1z */
  OPT_std_c__98 = 1288,                      /* -std=c++98 */
  OPT_std_c11 = 1289,                        /* -std=c11 */
  /* OPT_std_c1x = 1290, */                  /* -std=c1x */
  /* OPT_std_c89 = 1291, */                  /* -std=c89 */
  OPT_std_c90 = 1292,                        /* -std=c90 */
  OPT_std_c99 = 1293,                        /* -std=c99 */
  /* OPT_std_c9x = 1294, */                  /* -std=c9x */
  OPT_std_f2003 = 1295,                      /* -std=f2003 */
  OPT_std_f2008 = 1296,                      /* -std=f2008 */
  OPT_std_f2008ts = 1297,                    /* -std=f2008ts */
  OPT_std_f95 = 1298,                        /* -std=f95 */
  OPT_std_gnu = 1299,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1300, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1301, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1302,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 1303,                    /* -std=gnu++14 */
  /* OPT_std_gnu__17 = 1304, */              /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 1305, */              /* -std=gnu++1y */
  OPT_std_gnu__1z = 1306,                    /* -std=gnu++1z */
  OPT_std_gnu__98 = 1307,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1308,                      /* -std=gnu11 */
  /* OPT_std_gnu1x = 1309, */                /* -std=gnu1x */
  /* OPT_std_gnu89 = 1310, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1311,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1312,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1313, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1314, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1315,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1316, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1317, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1318, */         /* -std=iso9899:2011 */
