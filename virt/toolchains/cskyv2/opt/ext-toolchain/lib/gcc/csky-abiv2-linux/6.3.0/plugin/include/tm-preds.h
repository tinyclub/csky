/* Generated automatically by the program 'build/genpreds'
   from the machine description file '/home/rtos_nfs/toolsbuild/slave-64/workspace/tools3_build_64_uclibc/abiv2_uclibc/source//gcc/gcc/config/csky/abiv2_csky.md'.  */
				      ...
				      bool *allows_reg, bool *allows_mem)
{
  if (c >= CONSTRAINT_Un && c <= CONSTRAINT_Ue)
    return;
  if (c >= CONSTRAINT_V && c <= CONSTRAINT_R)
    {
      *allows_mem = true;
      return;
    }
